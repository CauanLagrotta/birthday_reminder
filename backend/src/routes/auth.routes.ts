...
auth_routes.get("/reset-password/:token", resetPasswordController.requestResetToken as unknown as express.RequestHandler) // http://localhost:3000/auth/reset-password/:token
auth_routes.put("/reset-password/:id/:token", resetPasswordController.resetPassword as unknown as express.RequestHandler) // http://localhost:3000/auth/reset-password/:id/:token